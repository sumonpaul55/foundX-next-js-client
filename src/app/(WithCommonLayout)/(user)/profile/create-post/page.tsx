...
const CreatePost = () => {
    const { mutate: handleCreatePost, isPending: createPendding, isSuccess } = useCreatePost()
    ...
    // navigate after create post
    if (!createPendding && isSuccess) {
        router.push("/")
    }
